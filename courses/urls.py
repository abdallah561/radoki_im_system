...
urlpatterns = [
    ...
    path('lessons/<int:lesson_id>/video-links/add/', views.add_lesson_video_link, name='add_lesson_video_link'),
    path('lesson-video-links/<int:link_id>/delete/', views.delete_lesson_video_link, name='delete_lesson_video_link'),
    path('lessons/<int:lesson_id>/resources/add/', views.add_lesson_additional_resource, name='add_lesson_additional_resource'),
    path('lesson-resources/<int:resource_id>/delete/', views.delete_lesson_additional_resource, name='delete_lesson_additional_resource'),
    ...
    path('recordings/<int:recording_id>/resources/add/', views.add_lesson_recording_resource, name='add_lesson_recording_resource'),
    path('recording-resources/<int:resource_id>/delete/', views.delete_lesson_recording_resource, name='delete_lesson_recording_resource'),
